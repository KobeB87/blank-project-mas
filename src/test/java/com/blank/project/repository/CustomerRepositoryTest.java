...
public class CustomerRepositoryTest {
    ...
    public void findByCustomerId() {
        ...
        Optional<Customer> newCustomer = this.customerRepository.findByCustomerId(CUSTOMER_ID);
    ...
    public void findByCustomerIdReturnsNoResults() {
        Optional<Customer> newCustomer = this.customerRepository.findByCustomerId("differentId");
